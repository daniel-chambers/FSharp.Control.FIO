...
let summary = "F# version of Scala's ZIO Environment"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "F# version of Scala's ZIO Environment"

// List of author names (for NuGet package)
let author = "Daniel Chambers"

// Tags for your project (for NuGet package)
let tags = "f# fsharp monad async concurrency applicative"
...
let gitOwner = "daniel-chambers"
let gitHome = sprintf "%s/%s" "https://github.com" gitOwner

// The name of the project on GitHub
let gitName = "FSharp.Control.FIO"

// The url for the raw files hosted
let gitRaw = Environment.environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/daniel-chambers"

let website = "/FSharp.Control.FIO"
...
let info =
  [ "project-name", "FIO"
    ...
    "project-nuget", "http://nuget.org/packages/FIO" ]
